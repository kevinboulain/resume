\startcomponent[jobs]
  ...
  Network monitoring appliance editor
  \blank
  ...
  \startexperienceactivity
    ...
    \item Contributions to the web interface written in Python
    \startexperienceactivity
      \item optimizations to the SQL output of a small EDSL created for a replacement database
    \stopexperienceactivity

    \item Reinforcement of the Buildbot-based test infrastructure
